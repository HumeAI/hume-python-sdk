...
class StateEmbeddingGeneration_Queued(pydantic_v1.BaseModel):
...
class StateEmbeddingGeneration_InProgress(pydantic_v1.BaseModel):
    created_timestamp_ms: int
...
class StateEmbeddingGeneration_Completed(pydantic_v1.BaseModel):
    created_timestamp_ms: int
    started_timestamp_ms: int
...
class StateEmbeddingGeneration_Failed(pydantic_v1.BaseModel):
    created_timestamp_ms: int
    started_timestamp_ms: int
    ended_timestamp_ms: int
    message: str
