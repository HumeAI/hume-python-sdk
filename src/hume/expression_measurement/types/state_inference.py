...
class StateInference_Queued(pydantic_v1.BaseModel):
...
class StateInference_InProgress(pydantic_v1.BaseModel):
    created_timestamp_ms: int
...
class StateInference_Completed(pydantic_v1.BaseModel):
    created_timestamp_ms: int
    started_timestamp_ms: int
...
class StateInference_Failed(pydantic_v1.BaseModel):
    created_timestamp_ms: int
    started_timestamp_ms: int
    ended_timestamp_ms: int
    message: str
