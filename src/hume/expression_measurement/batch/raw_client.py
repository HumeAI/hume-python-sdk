...
class RawBatchClient:
    ...
    ) -> HttpResponse[typing.List[UnionJob]]:
        """
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            json={
                "models": convert_and_respect_annotation_metadata(
                    object_=models, annotation=Models, direction="write"
                ),
    ...
    def get_job_predictions(
        self, id: str, *, request_options: typing.Optional[RequestOptions] = None
    ) -> HttpResponse[typing.List[UnionPredictResult]]:
        """
    ...
    def start_inference_job_from_local_file(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            data={
                "json": (
                    _json.dumps(jsonable_encoder(json))
                    if json is not None and json is not OMIT
                    else "{}"
                ),
            },
            files={
...
class AsyncRawBatchClient:
    ...
    async def list_jobs(
        ...
        *,
        ...
        direction: typing.Optional[Direction] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[typing.List[UnionJob]]:
        """
        Sort and filter jobs.
    ...
    async def get_job_predictions(
        self, id: str, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[typing.List[UnionPredictResult]]:
        """
        Get the JSON predictions of a completed inference job.
