...
import typing
import pydantic
from ...stream.types.text_position import TextPosition
from ...stream.types.emotion_embedding import EmotionEmbedding
from ...stream.types.sentiment import Sentiment
from ...stream.types.toxicity import Toxicity
