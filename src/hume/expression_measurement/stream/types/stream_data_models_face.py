...
class StreamDataModelsFace(pydantic_v1.BaseModel):
    """
    ...
    facs: typing.Optional[typing.Dict[str, typing.Any]] = pydantic_v1.Field(default=None)
    """
    Configuration for FACS predictions. If missing or null, no FACS predictions will be generated.
    """

    descriptions: typing.Optional[typing.Dict[str, typing.Any]] = pydantic_v1.Field(default=None)
    """
    ...
    min_face_size: typing.Optional[float] = pydantic_v1.Field(default=None)
    """
