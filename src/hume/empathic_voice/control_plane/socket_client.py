...
ControlPlaneSocketClientResponse = typing.Union[SubscribeEvent]


class AsyncControlPlaneSocketClient(EventEmitterMixin):
    ...
    async def send_publish(self, message: ControlPlanePublishEvent) -> None:
        """
        Send a message to the websocket connection.
        The message will be sent as a ControlPlanePublishEvent.
        """
        await self._send_model(message)

    async def recv(self) -> ControlPlaneSocketClientResponse:
        """
...
class ControlPlaneSocketClient(EventEmitterMixin):
    ...
    def send_publish(self, message: ControlPlanePublishEvent) -> None:
        """
        Send a message to the websocket connection.
        The message will be sent as a ControlPlanePublishEvent.
        """
    ...
    def recv(self) -> ControlPlaneSocketClientResponse:
        """
        Receive a message from the websocket connection.
        """
