...
class PostedTimeoutSpecs(pydantic_v1.BaseModel):
    """
    ...
    inactivity: typing.Optional[PostedTimeoutSpecsInactivity] = pydantic_v1.Field(default=None)
    """
    ...
    max_duration: typing.Optional[PostedTimeoutSpecsMaxDuration] = pydantic_v1.Field(default=None)
    """
