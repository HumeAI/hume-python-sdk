...
class ReturnEventMessageSpecs(pydantic_v1.BaseModel):
    """
    ...
    on_new_chat: typing.Optional[ReturnEventMessageSpec] = pydantic_v1.Field(default=None)
    """
    Specifies the initial message EVI provides when a new chat is started, such as a greeting or welcome message.
    """

    on_inactivity_timeout: typing.Optional[ReturnEventMessageSpec] = pydantic_v1.Field(default=None)
    """
    ...
    on_max_duration_timeout: typing.Optional[ReturnEventMessageSpec] = pydantic_v1.Field(default=None)
    """
