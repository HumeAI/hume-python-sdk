...
from hume.core.http_client import (
    AsyncHttpClient,
    HttpClient,
    _build_url,
    get_request_body,
...
@patch("hume.core.http_client.time.sleep", return_value=None)
...
@pytest.mark.asyncio
@patch("hume.core.http_client.asyncio.sleep", new_callable=AsyncMock)
