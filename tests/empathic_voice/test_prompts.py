...
async def test_delete_prompt(client: HumeClient, async_client: AsyncHumeClient) -> None:
    ...
    assert (
        client.empathic_voice.prompts.delete_prompt(id="af699d45-2985-42cc-91b9-af9e5da3bac5")  # type: ignore[func-returns-value]
        is None
    )

    assert (
        await async_client.empathic_voice.prompts.delete_prompt(id="af699d45-2985-42cc-91b9-af9e5da3bac5")  # type: ignore[func-returns-value]
        is None
    )
...
async def test_delete_prompt_version(client: HumeClient, async_client: AsyncHumeClient) -> None:
    # Type ignore to avoid mypy complaining about the function not being meant to return a value
    assert (
        client.empathic_voice.prompts.delete_prompt_version(id="af699d45-2985-42cc-91b9-af9e5da3bac5", version=1)  # type: ignore[func-returns-value]
        is None
    )

    assert (
        await async_client.empathic_voice.prompts.delete_prompt_version(
            id="af699d45-2985-42cc-91b9-af9e5da3bac5", version=1
        )  # type: ignore[func-returns-value]
        is None
    )
